...
//     	string+='"description":"'+document.getElementById('desc').value+'",';
//     	string+='"notes":"'+document.getElementById('notes').value+'",';
//     	string+='"supplier":"'+document.getElementById('supp').value+'",';
//     	string+='"price":"'+document.getElementById('price').value+'",';
//     	string+='"currency":"'+document.getElementById('curr').value+'"}';

//     	localStorage.setItem("localJson", string);
    	
//     	console.log(localstorage.getItem("localJson"));
//     	});
// });
// });
 ...
 $(document).ready(function () {
      ...
      if (localStorage) {
        ...
        $("input[type=text]").change(function(){
    	  ...
    	  if (confirm('Are you sure you want to save this thing into local storage?')) {
    		    // Save it!
    		} else {
...
<form id="materialForm">
	<table>
		...
		<tr><td><input type="button"  id="buttonSave"  value="Save"></td></tr>
	</table>
</form>	
